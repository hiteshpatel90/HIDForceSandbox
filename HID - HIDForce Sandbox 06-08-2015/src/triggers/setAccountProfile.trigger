    ...
    if(!utilController.bolSetAccountProfile){
        ...
        for(Lead mylead : trigger.new){
            if(myLead.status == 'Qualified'){
                ...
                if(myLead.Business_Segment__c == 'PACS' || myLead.Business_Segment__c == 'ID Assurance' || myLead.Business_Segment__c == 'Identity Assurance' || myLead.Business_Segment__c == 'Secure Issuance'){
