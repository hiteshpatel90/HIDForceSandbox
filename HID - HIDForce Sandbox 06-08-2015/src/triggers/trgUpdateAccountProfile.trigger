////////////////////////////////////////////////////////////////////
//Type                    : Apex Trigger
//Name                    : trgUpdateAccountProfile 
//Company                 : Jade Global
//Created By              : Hitesh Patel
//Created Date            : 07/05/2014
//Last Modified By        : xyz
//Last Modified Date      : 07/05/2014
//Description             : update account field to track whenever account profile related list records are getting created or modified.
/////////////////////////////////////////////////////////////////////
trigger trgUpdateAccountProfile on Account_Profile__c (after insert, after update) {
    //Define list variable of account for update
    List<Account> lstAccountUpdate = new List<Account>();
    List<Account> lstNewAccountUpdate = new List<Account>();
    //Define set variable of Id to get related account record
    set<Id> sAccId = new set<Id>();
    for(Account_Profile__c pp: trigger.new){
    ...
    for(Account acc: lstAccount){
        ...
        acc.Account_Profile_Modified_Date__c = system.now();
        acc.SkipValidation__c=true;
